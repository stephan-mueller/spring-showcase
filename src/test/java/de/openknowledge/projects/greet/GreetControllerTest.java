...
/**
 * Test class for the resource {@link GreetController}.
 */
@ExtendWith(MockitoExtension.class)
class GreetControllerTest {

  @InjectMocks
  private GreetController resource;
  ...
  void greet() {
    ...
    ResponseEntity<GreetDTO> response = resource.greet("Stephan");
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(response.getBody()).isEqualTo(new GreetDTO("Hola Stephan!"));
  ...
  void greetTheWorld() {
    ...
    ResponseEntity<GreetDTO> response = resource.greetTheWorld();
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(response.getBody()).isEqualTo(new GreetDTO("Hello World!"));
  ...
  void getGreeting() {
    ...
    ResponseEntity<GreetingDTO> response = resource.getGreeting();
    assertThat(response.getStatusCode()).isEqualTo(HttpStatus.OK);
    assertThat(response.getBody()).isEqualTo(new GreetingDTO("Hola"));
  ...
  void updateGreeting() {
    ...
    ResponseEntity<?> response = resource.updateGreeting(newGreeting);
